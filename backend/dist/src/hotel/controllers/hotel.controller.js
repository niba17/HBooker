...
let HotelController = class HotelController {
    ...
    async createOrUpdateHotel(createHotelDto) {
...
], HotelController.prototype, "getHotelInfo", null);
__decorate([
    (0, public_decorator_1.Public)(),
    ...
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], HotelController.prototype, "getAllAmenities", null);
__decorate([
    (0, common_1.Post)(),
    ...
    __metadata("design:returntype", Promise)
], HotelController.prototype, "createOrUpdateHotel", null);
